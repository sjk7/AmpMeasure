...
namespace AmpMeasure
{
    public partial class AmpMeasureMain
    {
        ...
        {
            _profiler.StartTimer("Grid: Clear");
            
            int rowCount = _virtualDataStore.Count;
            System.Diagnostics.Debug.WriteLine($"ClearVirtualData: Clearing {rowCount} rows, RowCount={dataGridView1.RowCount}");
            ...
            System.Diagnostics.Debug.WriteLine($"  Data cleared in {sw.ElapsedMilliseconds}ms");
            
            // Don't change RowCount - just refresh
            sw.Restart();
            dataGridView1.Invalidate();
            System.Diagnostics.Debug.WriteLine($"  Invalidate in {sw.ElapsedMilliseconds}ms");
            
            _profiler.StopTimer("Grid: Clear");
        }
